    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemCategoryGroups", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SchoolTerms_AcademicYears_AcademicYearId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OwningDepartmentId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    UpdatedBy = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Projects_Departments_OwningDepartmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "text", nullable: true),
                    SortOrder = table.Column<int>(type: "integer", nullable: false),
                    ItemCategoryGroupId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    UpdatedBy = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ItemCategories_ItemCategoryGroups_ItemCategoryGroupId",
                        column: x => x.ItemCategoryGroupId,
                        principalTable: "ItemCategoryGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SchoolLevelId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    UpdatedBy = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "DistributionHeaders",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    DistributionNumber = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DistributionHeaders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DistributionHeaders_Projects_ProjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    DistributionHeaderId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DistributionLines_DistributionHeaders_DistributionHeaderId",
                        column: x => x.DistributionHeaderId,
                        principalTable: "DistributionHeaders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DistributionLineId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StockTransactions_DistributionLines_DistributionLineId",
                        column: x => x.DistributionLineId,
                        principalTable: "DistributionLines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StockTransactions_StockLocations_DestinationLocationId",
                        column: x => x.DestinationLocationId,
                        principalTable: "StockLocations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StockTransactions_StockLocations_SourceLocationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DistributionHeaders_DistributionNumber",
                table: "DistributionHeaders",
                column: "DistributionNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DistributionHeaders_ProjectId",
                table: "DistributionHeaders",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_DistributionHeaders_Status",
                table: "DistributionHeaders",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_DistributionLines_DistributionHeaderId",
                table: "DistributionLines",
                column: "DistributionHeaderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemCategories_ItemCategoryGroupId",
                table: "ItemCategories",
                column: "ItemCategoryGroupId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Projects_OwningDepartmentId",
                table: "Projects",
                column: "OwningDepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_Regions_ExternalId",
                table: "Regions",
                column: "ExternalId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SchoolTerms_AcademicYearId",
                table: "SchoolTerms",
                column: "AcademicYearId");

            migrationBuilder.CreateIndex(
                name: "IX_StockBalances_ItemId_StockLocationId",
                table: "StockBalances",
                columns: new[] { "ItemId", "StockLocationId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockTransactions_DistributionLineId",
                table: "StockTransactions",
